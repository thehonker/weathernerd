/*
 * WeatherNerd — 8×8 ASCII font for SH1106 OLED
 *
 * Printable ASCII 0x20-0x7F (96 characters, 8 bytes each = 768 bytes).
 * Each byte is one row, MSB = leftmost pixel, 8 rows per character.
 * Standard font8x8_basic — public domain.
 */
...
static const uint8_t oled_font[] = {
    ...
    /* 0x2F '/' */ 0x00,0x60,0x30,0x18,0x0C,0x06,0x03,0x00,
    ...
    /* 0x33 '3' */ 0x1E,0x33,0x1C,0x1C,0x30,0x33,0x1E,0x00,
    ...
    /* 0x39 '9' */ 0x1E,0x33,0x33,0x3E,0x30,0x18,0x0C,0x00,
    ...
    /* 0x61 'a' */ 0x00,0x00,0x1E,0x30,0x3E,0x33,0x3E,0x00,
    /* 0x62 'b' */ 0x07,0x06,0x3E,0x66,0x66,0x66,0x3F,0x00,
    /* 0x63 'c' */ 0x00,0x00,0x1E,0x33,0x03,0x33,0x1E,0x00,
    /* 0x64 'd' */ 0x38,0x30,0x3E,0x33,0x33,0x33,0x3E,0x00,
    /* 0x65 'e' */ 0x00,0x00,0x1E,0x33,0x3F,0x03,0x1E,0x00,
    /* 0x66 'f' */ 0x1C,0x36,0x06,0x0F,0x06,0x06,0x0F,0x00,
    /* 0x67 'g' */ 0x00,0x00,0x3E,0x33,0x33,0x3E,0x30,0x1F,
    /* 0x68 'h' */ 0x07,0x06,0x3E,0x66,0x66,0x66,0x63,0x00,
    ...
    /* 0x70 'p' */ 0x00,0x00,0x3F,0x66,0x66,0x3E,0x06,0x0F,
    /* 0x71 'q' */ 0x00,0x00,0x3E,0x33,0x33,0x3E,0x30,0x38,
    /* 0x72 'r' */ 0x00,0x00,0x3F,0x66,0x06,0x06,0x0F,0x00,
    /* 0x73 's' */ 0x00,0x00,0x3E,0x03,0x1E,0x30,0x1E,0x00,
    /* 0x74 't' */ 0x08,0x0C,0x3E,0x0C,0x0C,0x2C,0x18,0x00,
    /* 0x75 'u' */ 0x00,0x00,0x33,0x33,0x33,0x33,0x3E,0x00,
